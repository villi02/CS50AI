...
knowledge3 = And(
    ...
    Implication(AKnight, And(CKnight, BKnave)), # Aknight -> Cknight, Bknave
    Implication(AKnave, And(CKnave, BKnave)), # Aknave -> Bknave, Cknave
    Implication(BKnave, And(CKnight, AKnight)), # Bknave -> Cknight, Aknight
